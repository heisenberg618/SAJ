...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Service contentieux, Mise en place D.C">
    <meta name="description" content="">
    <title>Contentieux</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Contentieux.css" media="screen">
    ...
    <meta property="og:title" content="Contentieux">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-4ccc" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-4"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="accueil.php">accueil</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link">service</a><div class="u-nav-popup"><ul class="u-h-spacing-21 u-nav u-unstyled u-v-spacing-17"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="amiable.php#carousel_6e28" data-page-id="258213860">service des dossiers amiable</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Contentieux.php#sec-e080" data-page-id="2940312430">service des dossiers contentieux</a><div class="u-nav-popup"><ul class="u-h-spacing-21 u-nav u-unstyled u-v-spacing-17"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Contentieux.php#sec-e080" data-page-id="2940312430" target="_blank">à propos du service</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Contentieux.php#sec-492f" data-page-id="2940312430">mise en place des dossiers contentieux</a>
</li></ul>
</div>
</li></ul>
</div>
    ...
    <section class="u-clearfix u-gradient u-section-1" id="sec-e080">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-palette-2-base u-text-1">Service contentieux</h1>
        <h3 class="u-text u-text-2">
          <span style="font-size: 1.5rem;">Ce service sert a mettre en vue la decision des dossiers fraudes après-traitement, en désirant que le resultat du traitement du dossier de client est en malversation, le service va mettre article du ploint au procédure devant le tribunal, ce type de fraude par exemple facture non payé choufrage d'electricité..</span>.
        </h3>
      <center>
        <a href="accueil.php#sec-fdd1" data-page-id="71525385" class="u-btn u-button-style u-none u-text-hover-palette-2-base u-text-palette-1-base u-btn-1">plus<span class="u-icon u-text-palette-1-base"><svg class="u-svg-content" viewBox="0 -32 426.66667 426" style="width: 1em; height: 1em;"><path d="m213.332031 181.667969c0 4.265625-1.277343 8.53125-3.625 11.730469l-106.667969 160c-3.839843 5.761718-10.238281 9.601562-17.707031 9.601562h-64c-11.730469 0-21.332031-9.601562-21.332031-21.332031 0-4.269531 1.28125-8.535157 3.625-11.734375l98.773438-148.265625-98.773438-148.269531c-2.34375-3.199219-3.625-7.464844-3.625-11.730469 0-11.734375 9.601562-21.335938 21.332031-21.335938h64c7.46875 0 13.867188 3.839844 17.707031 9.601563l106.667969 160c2.347657 3.199218 3.625 7.464844 3.625 11.734375zm0 0"></path><path d="m426.667969 181.667969c0 4.265625-1.28125 8.53125-3.628907 11.730469l-106.664062 160c-3.839844 5.761718-10.242188 9.601562-17.707031 9.601562h-64c-11.734375 0-21.335938-9.601562-21.335938-21.332031 0-4.269531 1.28125-8.535157 3.628907-11.734375l98.773437-148.265625-98.773437-148.269531c-2.347657-3.199219-3.628907-7.464844-3.628907-11.730469 0-11.734375 9.601563-21.335938 21.335938-21.335938h64c7.464843 0 13.867187 3.839844 17.707031 9.601563l106.664062 160c2.347657 3.199218 3.628907 7.464844 3.628907 11.734375zm0 0"></path></svg><img></span>
        </a>
      </center>
<br>
</br>
...
tr:nth-child(even){background-color: #ebebfa}
...
// Check connection
     ...
     $sql = "SELECT `id`, `num_affaire`, `date_d`, `type_avocat`, `procedure`, `cloture` FROM `contentieux`";
     $result = $conn->query($sql);
         ...
         echo "<tr>
           <td>" . $row["num_affaire"]. "</td>
           <td>" . $row["date_d"]. "</td>
           <td>" . $row["type_avocat"]. "</td>
           <td>" . $row["procedure"]. "</td>
           <td>" . $row["cloture"]. "</td>
              </tr>";
        }
     ...
     $conn->close();
      ...
      ?>
        ...
        <div class="u-form u-form-1">
          <form action="contentieuxmaj.php" method="POST" class="" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-2942" class="u-custom-font u-heading-font u-label u-text-palette-1-base u-label-1">N° d'affaire</label>
              <input type="number" id="name-2942" name="numC" class="u-border-2 u-border-palette-1-base u-custom-font u-heading-font u-input u-input-rectangle u-radius-11 u-text-black" required="">
            </div>
            <div class="u-form-date u-form-group u-form-group-2">
              <label for="date-ce7e" class="u-custom-font u-heading-font u-label u-text-palette-1-base u-label-2">Date debut</label>
              <input type="date" placeholder="MM/DD/YYYY" id="date-ce7e" name="DDC" class="u-border-2 u-border-palette-1-base u-custom-font u-heading-font u-input u-input-rectangle u-radius-11 u-text-black" required="">
            </div>
            <div class="u-form-group u-form-select u-form-group-3">
              <label for="select-222c" class="u-custom-font u-heading-font u-label u-text-palette-1-base u-label-3">type d'avocat</label>
              <div class="u-form-select-wrapper">
                <select id="select-222c" name="TA" class="u-border-2 u-border-palette-1-base u-custom-font u-heading-font u-input u-input-rectangle u-radius-11 u-text-black">
                  <option value="Externe">Externe</option>
                  <option value="Agent SAJ">Agent SAJ</option>
                </select>
                
              </div>
            </div>
            <div class="u-form-email u-form-group">
              <label for="email-2942" class="u-custom-font u-heading-font u-label u-text-palette-1-base u-label-4">Procédure</label>
              <input type="text" id="email-2942" name="PC" class="u-border-2 u-border-palette-1-base u-custom-font u-heading-font u-input u-input-rectangle u-radius-11 u-text-black" required="">
            </div>
            <div class="u-form-group u-form-select u-form-group-5">
              <label for="select-325f" class="u-custom-font u-heading-font u-label u-text-palette-1-base u-label-5">Cloture</label>
              <div class="u-form-select-wrapper">
                <select id="select-325f" name="Cloture" class="u-border-2 u-border-palette-1-base u-custom-font u-heading-font u-input u-input-rectangle u-radius-11 u-text-black">
